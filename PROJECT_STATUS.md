...
Snapshot taken August 11, 2026. All numbers are verified against the released
code and are reproducible with `arabizikit eval`.
...
- Python library plus CLI (`pip install arabizikit`)
- Browser demo at https://arabizi-kit.vercel.app
- npm package (built and verified, publish pending)
- Paper draft in `paper/outline.md` for arXiv
...
`tests/` (13 test files), `paper/`, plus `pyproject.toml`, `README.md`,
`RELEASE.md`, `PROJECT_STATUS.md`.
